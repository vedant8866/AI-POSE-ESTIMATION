...
while True:
    ...
    if len(lmList) !=0:
        ...
        if lmList[11][2]>lmList[14][2]:  
            wrist.append([lmList[14][1], lmList[14][2]-detector.length(image,14,16)]) 
            wrist.append([lmList[13][1], lmList[13][2]-detector.length(image,14,16)])
